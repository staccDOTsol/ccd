...
/*
namespace CreateCoin { namespace plugin_tests {

using namespace CreateCoin::app;
using namespace CreateCoin::chain;
...
CreateCoin_DEFINE_PLUGIN_EVALUATOR( test_plugin, test_a_operation, test_a );
CreateCoin_DEFINE_PLUGIN_EVALUATOR( test_plugin, test_b_operation, test_b );
...
} } // CreateCoin::plugin_tests

CreateCoin_DEFINE_PLUGIN( test, CreateCoin::plugin_tests::test_plugin )

FC_REFLECT( CreateCoin::plugin_tests::test_a_operation, (account) )
FC_REFLECT( CreateCoin::plugin_tests::test_b_operation, (account) )

CreateCoin_DECLARE_OPERATION_TYPE( CreateCoin::plugin_tests::test_op );
FC_REFLECT_TYPENAME( CreateCoin::plugin_tests::test_op );
CreateCoin_DEFINE_OPERATION_TYPE( CreateCoin::plugin_tests::test_op );
*/
