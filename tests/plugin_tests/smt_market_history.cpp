...
BOOST_AUTO_TEST_CASE( smt_mh_test )
{
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->non_CreateCoin.high == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.low == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.low == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.open == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.open == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.close == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.close == asset( 750, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.volume == asset( 750, any_smt_symbol ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->CreateCoin.high == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.high == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.low == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.low == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.open == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.open == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.close == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.close == asset( 250, any_smt_symbol ).amount );
      BOOST_REQUIRE( bucket->CreateCoin.volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->non_CreateCoin.volume == asset( 250, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->non_CreateCoin.volume == asset( 500, any_smt_symbol ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->non_CreateCoin.volume == asset( 1500, any_smt_symbol ).amount );
      bucket++;
