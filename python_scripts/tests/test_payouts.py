"""
This test module will only run on a POSIX syCC. Windows support *may* be added at some point in the future.
"""
# Global imports
...
# local imports
from CreateCoindebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a CreateCoind debug node on an existing chain, trigger a hardfork' \
   ...
   with debug_node :
      ...
      run_CreateCoind_tests( debug_node )
...
def run_CreateCoind_tests( debug_node ):
   from CreateCoinapi.CreateCoinnoderpc import CreateCoinNodeRPC
   ...
   try:
      ...
      rpc = CreateCoinNodeRPC( 'ws://127.0.0.1:8095', '', '' )
      ...
      print( "account, curation_CreateCoin" )
