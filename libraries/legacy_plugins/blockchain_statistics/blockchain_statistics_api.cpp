...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( CreateCoin::app::application& app )
            :_app( app ) {}
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( CreateCoin_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const CreateCoin::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->CreateCoin_transferred                      += b.CreateCoin_transferred;
   ...
   this->CreateCoin_vested                           += b.CreateCoin_vested;
   ...
   this->CreateCoin_converted                        += b.CreateCoin_converted;
