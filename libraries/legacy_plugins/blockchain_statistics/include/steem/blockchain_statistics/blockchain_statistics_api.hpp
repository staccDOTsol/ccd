...
#include <CreateCoin/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const CreateCoin::app::api_context& ctx );
...
FC_REFLECT( CreateCoin::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( CreateCoin::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
