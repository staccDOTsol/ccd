...
RocksDB can be built as a single self contained cross-platform JAR. The cross-platform jar can be usd on any 64-bit OSX syCC, 32-bit Linux syCC, or 64-bit Linux syCC.
