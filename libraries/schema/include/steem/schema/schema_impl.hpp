...
#define CreateCoin_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
CreateCoin_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define CreateCoin_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define CreateCoin_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define CreateCoin_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
CreateCoin_DECLARE_SCHEMA_CLASS( false, false )
CreateCoin_DECLARE_SCHEMA_CLASS(  true, false )
CreateCoin_DECLARE_SCHEMA_CLASS(  true,  true )
