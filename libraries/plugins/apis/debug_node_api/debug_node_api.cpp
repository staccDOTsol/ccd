#include <CreateCoin/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <CreateCoin/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > CreateCoin_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( CreateCoin_DEBUG_NODE_API_PLUGIN_NAME );
}
