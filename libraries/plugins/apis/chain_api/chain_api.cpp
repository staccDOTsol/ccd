#include <CreateCoin/plugins/chain_api/chain_api_plugin.hpp>
#include <CreateCoin/plugins/chain_api/chain_api.hpp>
...
{
   JSON_RPC_REGISTER_API( CreateCoin_CHAIN_API_PLUGIN_NAME );
}
