   ...
   class network_broadcast_api_impl
   {
      public:
         network_broadcast_api_impl() :
            _p2p( appbase::app().get_plugin< CreateCoin::plugins::p2p::p2p_plugin >() ),
         ...
         CreateCoin::plugins::p2p::p2p_plugin&                      _p2p;
...
{
   JSON_RPC_REGISTER_API( CreateCoin_NETWORK_BROADCAST_API_PLUGIN_NAME );
}
