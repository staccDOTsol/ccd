#include <CreateCoin/plugins/rc_api/rc_api_plugin.hpp>
#include <CreateCoin/plugins/rc_api/rc_api.hpp>
...
{
   public:
      rc_api_impl() : _db( appbase::app().get_plugin< CreateCoin::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( CreateCoin_RC_API_PLUGIN_NAME );
}
