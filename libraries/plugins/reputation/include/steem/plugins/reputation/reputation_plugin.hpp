...
#define CreateCoin_REPUTATION_PLUGIN_NAME "reputation"
...
class reputation_plugin : public appbase::plugin< reputation_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = CreateCoin_REPUTATION_PLUGIN_NAME; return name; }
