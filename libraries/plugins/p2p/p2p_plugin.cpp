...
#include <CreateCoin/plugins/p2p/p2p_default_seeds.hpp>
...
using CreateCoin::protocol::block_header;
...
public:
   ...
   virtual CreateCoin::protocol::chain_id_type get_chain_id() const override;
...
CreateCoin::protocol::chain_id_type p2p_plugin_impl::get_chain_id() const
{
...
void p2p_plugin::plugin_initialize(const boost::program_options::variables_map& options)
{
   ...
   my->user_agent = "CreateCoin Reference Implementation";
...
void p2p_plugin::broadcast_block( const CreateCoin::protocol::signed_block& block )
{
   ulog("Broadcasting block #${n}", ("n", block.block_num()));
   my->node->broadcast( graphene::net::block_message( block ) );
}

void p2p_plugin::broadcast_transaction( const CreateCoin::protocol::signed_transaction& tx )
{
...
} } } // namespace CreateCoin::plugins::p2p
