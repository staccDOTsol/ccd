...
operation_tests      // Unit Tests of CreateCoin operations
operation_time_tests // Tests of CreateCoin operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_CreateCoin_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
